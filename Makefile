notebook: the_annotated_transformer.py
	uv run jupytext --to ipynb the_annotated_transformer.py

py: the_annotated_transformer.ipynb
	uv run jupytext --to py:percent the_annotated_transformer.ipynb
...
html: the_annotated_transformer.ipynb
	uv run jupytext --execute --to ipynb the_annotated_transformer.py
	uv run jupyter nbconvert --to html the_annotated_transformer.ipynb

the_annotated_transformer.md: the_annotated_transformer.ipynb
	uv run jupyter nbconvert --to markdown  --execute the_annotated_transformer.ipynb
